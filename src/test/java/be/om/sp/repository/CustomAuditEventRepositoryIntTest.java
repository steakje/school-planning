package be.om.sp.repository;

import be.om.sp.SchoolPlanningApp;
import be.om.sp.config.Constants;
import be.om.sp.config.audit.AuditEventConverter;
import be.om.sp.domain.PersistentAuditEvent;
...
import static be.om.sp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
