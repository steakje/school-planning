package be.om.sp.web.rest;

import be.om.sp.config.Constants;
import be.om.sp.SchoolPlanningApp;
import be.om.sp.domain.Authority;
import be.om.sp.domain.User;
import be.om.sp.repository.AuthorityRepository;
import be.om.sp.repository.UserRepository;
import be.om.sp.security.AuthoritiesConstants;
import be.om.sp.service.MailService;
import be.om.sp.service.dto.UserDTO;
import be.om.sp.service.dto.PasswordChangeDTO;
import be.om.sp.web.rest.errors.ExceptionTranslator;
import be.om.sp.web.rest.vm.KeyAndPasswordVM;
import be.om.sp.web.rest.vm.ManagedUserVM;
import be.om.sp.service.UserService;
...
@SpringBootTest(classes = SchoolPlanningApp.class)
